...
Logs various actions / changes on your server

## Usage

Find out how this plugin works on the [plugin documentation page](https://scm-manager.org/plugins/scm-audit-log-plugin/docs/).
